...
function MidLeftNotification(msg) {
  AddNotification(msg, $('#MidLeftNotifications'));
}

function MidLeftRemoveNotification(msg){
  RemoveNotification(msg, $('#MidLeftNotifications'));
}
