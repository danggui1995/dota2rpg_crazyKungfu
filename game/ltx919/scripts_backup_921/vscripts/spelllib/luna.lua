...
function moon_glaive_start_create_dummy( keys )
	...
	local dummy = CreateUnitByName( "npc_dota_dummy_caster", target:GetAbsOrigin(), false, caster, caster, caster:GetTeamNumber() )
	...
	dummy_ability.particle_name = GameRules.dandao[caster:GetUnitName()] or "particles/units/heroes/hero_luna/luna_base_attack.vpcf"
	dummy_ability.projectile_speed = 900
