...
function modifier_huskar_berserkers_blood_lua:OnRefresh()
	self.berserkers_blood_magic_resist = self:GetAbility():GetSpecialValueFor( "damage_per_stack" )
	self.berserkers_blood_attack_speed = self:GetAbility():GetSpecialValueFor( "attack_speed_bonus_per_stack" )
...
function modifier_huskar_berserkers_blood_lua:GetModifierPreAttack_BonusDamage( params )
