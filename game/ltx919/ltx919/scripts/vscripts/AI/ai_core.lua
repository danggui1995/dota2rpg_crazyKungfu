...
function AICore:IsUnitTarget( hAbility )
    ...
    return false]]
    if bit.band(b,DOTA_ABILITY_BEHAVIOR_UNIT_TARGET)~=0 then
    	return true 
    end
    return false
end
...
function AICore:IsPoint( hAbility )
    ...
    return false]]
    if bit.band(b,DOTA_ABILITY_BEHAVIOR_POINT)~=0 then
    	return true 
    end
    return false
end
...
function AICore:IsNoTarget( hAbility )
    ...
    return false]]
    if bit.band(b,DOTA_ABILITY_BEHAVIOR_NO_TARGET)~=0 then
    	return true 
    end
    return false
...
function AICore:IsPassive( hAbility )
    local b = hAbility:GetBehavior()
    
    if bit.band(b,DOTA_ABILITY_BEHAVIOR_PASSIVE)~=0 then
    	return true 
    end
    return false
