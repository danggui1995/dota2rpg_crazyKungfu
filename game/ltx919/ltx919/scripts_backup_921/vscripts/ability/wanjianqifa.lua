...
function march_of_the_machines_spawn( keys )
	...
	local dummy = CreateUnitByName( "npc_dota_dummy_caster", caster:GetAbsOrigin(), false, caster, caster, caster:GetTeamNumber() )
	...
	Timers:CreateTimer( function()
			...
			local projectileTable = {
				Ability = ability,
				EffectName = "particles/mirana_spell_arrow_ltx.vpcf",
