...
function OnChuanSong( event,data )
	...
	if opt==nil then
		...
		elseif fb_type==2 or fb_type==3 or fb_type ==4 then
			pointname = "fb"..fb_type.."_enter"
		elseif fb_type==5 then
			pointname = "ent_liangongfang_gold"
		elseif fb_type==6 then
			pointname = "ent_liangongfang_xp"
		elseif fb_type==7 then
			pointname = "ent_fb5_enter"
		end
